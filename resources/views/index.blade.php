...
<div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
    <div class="card">
        <div class="card-header">
            ...
            <br>
              <img src="{{ (!empty($userData->photo)) ? url($userData->photo):url('upload/user_no_image.jpg') }}" alt="User" class="rounded-circle p-1 bg-primary" width="110">
...
<div class="row">
    ...
    <div class="form-group col-md-12">
      ...
      <div class="form-group col-md-12">
        ...
        <img id="showImage" src="{{ (!empty($userData->photo)) ? url($userData->photo):url('upload/user_no_image.jpg') }}" alt="User" class="rounded-circle p-1 bg-primary" width="110">
    </div>
